...
<td valign="top" width="50%">
  <div align="center">
    <b color="#1A73E8"> Sample Paper for Review </b><br>
    <a href="assets/motion-generation-paper.pdf"><img src="assets/motion-generation-paper-thumbnail.png" height="600" alt="Sample Paper"/></a><br>
...
<td valign="top">
  <div align="center">
    <b color="#1A73E8"> Review report generated by OpenReviewer</b><br>
    <a href="assets/review-report (motion-generation-paper).pdf"><img src="assets/review-report (motion-generation-paper)-thubmbnail.png" height="600" alt="Review Report"/></a><br>
    <b>The review report provides an automated, structured evaluation of a research paper, highlighting its core idea along with strengths, weaknesses, and a detailed scorecard.<br>
  </div>
</td>
</tr>
</table>
